...
void Sample3DSceneRenderer::StartTracking() { m_tracking = true; }

// When tracking, the 3D cube can be rotated around its Y axis by tracking pointer position relative to the output
// screen width.
...
void Sample3DSceneRenderer::StopTracking() { m_tracking = false; }
